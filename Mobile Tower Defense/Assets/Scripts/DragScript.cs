...
public class MoveObjects : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (touched && touch.phase == TouchPhase.Moved)//Move the tower prefab, ray casting the grid position at the touched input
        {
            dragging = true;
        ...
        if (dragging && (touch.phase == TouchPhase.Ended || touch.phase == TouchPhase.Canceled))//place the tower prefab at the touch position grid square
        {
            dragging = false;
            touched = false;
